    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <asp:TextBox ID="Payment" style="width:100%"  runat="server" Enabled="false"></asp:TextBox>
             <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator2" style="color:crimson" runat="server" ControlToValidate="Payment" ValidationGroup="SubmitValidation" ErrorMessage="required*"></asp:RequiredFieldValidator>--%>
        </div>
        <div class="col-md-2 text-right">
